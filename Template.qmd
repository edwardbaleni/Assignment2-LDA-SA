...
Ramaphosa's positive sentiment seems to be very hopeful. He talks about plans, progress and steps forward. These ideas are indicative of a process or belief of a process to betterment.

Mandela's positive sentiment worked around ideas of humanity. The reconcilliation commission, national unity, human dignity and affirmative action are all ideas that were prophesed in hopes of establishing a cooperative and friendlier social environment.

Mbeki was very focused on the improvement of the country's economic status. Most of his positive sentiment includes words that envoke the idea of an increasing economy.

For some of these presidents, the bing dictionary was adequate in finding positive sentiment.
...
In Figure 6, each president seems to have a number of repeating phrases that are meant to convey negative sentiment.

Both Motlanthe and Mbeki happen to have very similar ideas about the negative sentiment. This is understandable as Motlanthe took office after the resignation of Thabo Mbeki, it seems by looking at these plots of negative sentiment that these two presidents were dealing with crime and poverty.

Some of these sentiments are in fact quite positive. This is a show of how not every negation can be countered beforehand. For example, bigrams like criminal justice, poverty alleviation and anti corruption, have been shown to hold a negative meaning. These same bigrams could've just as easily had a positive connotation. Anti corruption is the fight against something quite bad, that is corruption; criminal justice is the fight against crime; poverty alleviation is the mitigation of poverty. All these sentiments have been categorized as negative where in fact their meaning is quite positive. Such a realization puts into context some limitations that come about from the use of dictionaries that may have value some of these positive or negative as neutral, or not valued them at all. These types of bigrams would have been better classified as neutral as the two terms cancel each other out.

During Zuma's presidency, the negative sentiment that was expressed was undeniably negative. It seemed to be a period that was ladeled with greater amounts of corruption as this is a topic that appears the most. Apart from the attempt to combat corruption, the sentiment in Zuma's speeches does not seem to have any double meaning. The speaker seems to speak on the financial and economic crisis that plagued the country at the time.

Ramaphosa's negative sentiment is rather ambiguous. It is clear that at this time a very frequent topic was railways, employment, corruption and equality. The word rail has been given negative sentiment while it's accompanying words are either neutral or not defined in the bing dicitonary, this is rather obscure as a physical object such as train tracks should not necessarily hold negative connotations. It may not exactly be accurate to say that this rail is a negative sentiment. That along with critical skill and critical role, demonstrates that Ramaphosa's negative bigram sentiments were not able to capture the true meaning behind his statements. This is an indication that either the bing dictionary was not good pick for this task or the possibility that Ramaphosa refrained from giving out bad news, or buried it in some roundabout way.

<!-- I have no idea what to say about deKlerk and Mandela -->
...
It should be noted about the bigram plots in Figures 5, Figure 6 and in the Figures present in the [Appendix](Appendix.qmd), is that in comparison to the unigram sentiment, the bigram sentiments are not as frequently occuring.

In the [Appendix](Appendix.qmd), it can be seen that negation words do appear frequently in these speeches or in front of other words. There are some that appear, but they are so in frequent that it will in general not affect the interpretation of the unigram sentiment. As mentioned above, it is clear that for these political speeches, a number of case specific negation words were excluded in the analysis of negation words.

### *Topic Modelling*

To specify an LDA model, one has to specify the number of topics one could expect to see in a document. Having selected this number of topics, the LDA will produces two outputs beta, $\beta$, and gamma, $\gamma$. Where $\beta$ is a parameter that controls the probability of a topic generating a particular word and $gamma$ gives the proportions of topics in a document \url{IanDurbach.html}.

We first look into the $\beta$'s, the word-topic probabilities. To find a decent number of topics we ran 2, 3 and 4 topics in the LDA function and found that 4 topics gives the best result of the option.

Both 2 and 3 topics had topics that had almost the same words, although it is possible for topics to share some terms, the number of similar terms between topics was so great that it was difficult to distinguish the topics at all. When 4 topics was used, there were much clearer distintions between the topics, this can be seen in Figure 7.
...
In Figure 7, we see that although there still remains some common terms between some of the topics, majority of the words are unique to their topic. The words in each of the four topics seem to infer a potential idea for each.

Topic 1 looks to have words related to economic growth. This can be seen in how words like economy, investment, support, growth, sector and business fall into this topic. These are terms that are associated with economic behaviour and business.

Topic 2 looks to have words related to social development. This can be seen in the inculsion of words like people, development, ensure, regard, social and system. These words are related to social behaviour.

Topic 3 looks to have words related to public governance / government policy. This can be seen in the inculsion of words like governement, public, service, nation, parliament and democracy. These are all aspects that are related to government involvement.

Topic 4 can be seen to have ideas related to politics and admin. This topic is rather ambiguous, which resulted in it taking on two main ideas. On the side of politics there are words like national, Africa, honourable, president and chairperson. On the side of admin there are words like programme, million, infastructure and water.

Since these topics seem somewhat distinguishable, the LDA has successfully discriminated between the 4 topics.
...
Next we are able to analyse the document-topic probabilities, $\gamma$'s. This as mentioned prior describes each document as a mixture of topics. It is helpful in analysing the proportions of a topic present in the document.

In Figure 8, these $\gamma$'s are captured across the speeches allowing the visualization of trend in topic over time for each president. This would aid in identifying what the general idea of the speech at a given time was.

Mandela was very involved in ideas of politics and admin. This makes sense as this was a period of transformation in government. Policy and administration were two very important points that needed to be tackled to escape the previously oppressive and hateful era. This emphasis on protecting the new governement structure and politics is further reflected in how the topics of public governance are also strongly occuring topics in his speeches.

Almost every speech that Ramaphosa has given strongly deals with the topics of economic growth, this is shown in the dominating document-topic probabilities of the topic over all of Ramphosa's speeches. In his last two speeches it would seem that he gave more attention to politics and administration, while still focusing heavily on economic growth.

Mbeki tried to touch on as many topics as he possibly could. In each speech that Thabo makes the dominating topic seems to shift. In his first and third speeches he seems to talk on politics and administration. In his second and sixth speech his dominating topic is that of social development. His fifth, eighth and nineth speeches deal with government policy. His fourth and seventh speech have a combination of ideas...

Zuma's speeches revolve around two topics, economic growth and government policy.
...
The table below illustrates examples of sentences that may aid in demonstrating the meaning of each topic.
